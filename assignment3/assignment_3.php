...
<div id="guest">
	...
	<?php
		...
		$filename = $DOCUMENT_ROOT.'/php-course/assignment3/'.'cities.txt';
	...
	<p>For Admin Use Only: <a href="http://localhost/php-course/assignment3/assignment_3_view_guestbook.php" target="_blank">View Guestbook</a></p>
